		...
		*/
		public function render_reviews_grid( $attributes ) {
			...
			if ('yes' !== get_option('ivole_reviews_nobranding', 'yes')) {
				...
				$cr_credits_line .= '<span>Powered by</span><a href="https://wordpress.org/plugins/customer-reviews-woocommerce/" target="_blank" alt="Customer Reviews for WooCommerce" title="Customer Reviews for WooCommerce"><img src="' . plugins_url( '/img/logo-vs.svg', dirname( dirname( __FILE__ ) ) ) . '"></a>';
				$cr_credits_line .= '</div>';
			}
