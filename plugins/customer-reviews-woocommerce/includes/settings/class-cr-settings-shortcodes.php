	...
	class CR_Shortcodes_Settings {
		...
		*/
		...
		public function show_shortcodes( $value ) {
			...
			'show_products="true" categories="" product_tags="" products="current" shop_reviews="true" number_shop_reviews="-1" inactive_products="false" show_replies="false" show_more="5" min_chars="0" avatars="initials" users="all" add_review="true"]</code></p>' .
			...
			'<li>' . sprintf( __( '%1$s parameter accepts %2$s or %3$s. Use it to display a form to write a new review.', 'customer-reviews-woocommerce' ), '<code>add_review</code>', '<code>"true"</code>', '<code>"false"</code>' ) . '</li>' .
			'</ul>' . '<br>' .
