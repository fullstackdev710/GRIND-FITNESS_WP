<?php
/*
Plugin Name: WPC Grouped Product for WooCommerce (Premium)
...
! defined( 'WOOSG_VERSION' ) && define( 'WOOSG_VERSION', '3.1.1' );
		...
		if ( ! class_exists( 'WPCleverWoosg' ) ) {
			class WPCleverWoosg {
				...
				function __construct() {
					...
					// Shortcode
					add_shortcode( 'woosg', array( $this, 'shortcode' ) );
					add_shortcode( 'woosg_form', array( $this, 'shortcode_form' ) );
					...
					// Backend AJAX search
					add_action( 'wp_ajax_woosg_update_search_settings', array( $this, 'update_search_settings' ) );
					add_action( 'wp_ajax_woosg_get_search_results', array( $this, 'get_search_results' ) );
					...
					add_action( 'woocommerce_woosg_add_to_cart', array( $this, 'add_to_cart_form' ) );
					...
					if ( get_option( '_woosg_search_sku', 'no' ) === 'yes' ) {
						add_filter( 'pre_get_posts', array( $this, 'search_sku' ), 99 );
					}

					if ( get_option( '_woosg_search_exact', 'no' ) === 'yes' ) {
						add_action( 'pre_get_posts', array( $this, 'search_exact' ), 99 );
					}

					if ( get_option( '_woosg_search_sentence', 'no' ) === 'yes' ) {
						add_action( 'pre_get_posts', array( $this, 'search_sentence' ), 99 );
					}
				}
                    ...
                    <div class="wpclever_settings_page wrap">
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                ...
                                -->
                                <a href="<?php echo esc_url( WOOSG_SUPPORT ); ?>" class="nav-tab" target="_blank">
									<?php esc_html_e( 'Support', 'wpc-grouped-product' ); ?>
                                </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_price_format">
                                                    <option value="normal" <?php echo esc_attr( get_option( '_woosg_price_format', 'from' ) === 'normal' ? 'selected' : '' ); ?>><?php esc_html_e( 'Normal price', 'wpc-grouped-product' ); ?></option>
                                                    <option value="from" <?php echo esc_attr( get_option( '_woosg_price_format', 'from' ) === 'from' ? 'selected' : '' ); ?>><?php esc_html_e( 'From price', 'wpc-grouped-product' ); ?></option>
                                                    <option value="auto" <?php echo esc_attr( get_option( '_woosg_price_format', 'from' ) === 'auto' ? 'selected' : '' ); ?>><?php esc_html_e( 'Auto calculated price', 'wpc-grouped-product' ); ?></option>
                                                    <option value="none" <?php echo esc_attr( get_option( '_woosg_price_format', 'from' ) === 'none' ? 'selected' : '' ); ?>><?php esc_html_e( 'None', 'wpc-grouped-product' ); ?></option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_position">
                                                    <option value="above" <?php echo esc_attr( get_option( '_woosg_position', 'above' ) === 'above' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Above add to cart button', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="below" <?php echo esc_attr( get_option( '_woosg_position', 'above' ) === 'below' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Under add to cart button', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="tab" <?php echo esc_attr( get_option( '_woosg_position', 'above' ) === 'tab' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'In a new tab', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_position', 'above' ) === 'no' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_variations_selector">
                                                    <option value="default" <?php echo esc_attr( get_option( '_woosg_variations_selector', 'default' ) === 'default' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Default', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="woovr" <?php echo esc_attr( get_option( '_woosg_variations_selector', 'default' ) === 'wpc_radio' || get_option( '_woosg_variations_selector', 'default' ) === 'woovr' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_show_thumb">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_show_thumb', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_show_thumb', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_show_description">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_show_description', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_show_description', 'no' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_show_price">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_show_price', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_show_price', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_selector">
                                                    <option value="quantity" <?php echo esc_attr( get_option( '_woosg_selector', 'quantity' ) === 'quantity' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Quantity', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="checkbox" <?php echo esc_attr( get_option( '_woosg_selector', 'quantity' ) === 'checkbox' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_show_plus_minus">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_show_plus_minus', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_show_plus_minus', 'no' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_link">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_link', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes, open in the same tab', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="yes_blank" <?php echo esc_attr( get_option( '_woosg_link', 'yes' ) === 'yes_blank' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes, open in the new tab', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="yes_popup" <?php echo esc_attr( get_option( '_woosg_link', 'yes' ) === 'yes_popup' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes, open quick view popup', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_link', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_change_image">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_change_image', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_change_image', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_change_price">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_change_price', 'yes' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="yes_custom" <?php echo esc_attr( get_option( '_woosg_change_price', 'yes' ) === 'yes_custom' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes, custom selector', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_change_price', 'yes' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_including_main">
                                                    <option value="yes" <?php echo esc_attr( get_option( '_woosg_including_main', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="no" <?php echo esc_attr( get_option( '_woosg_including_main', 'no' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woosg_main_price">
                                                    <option value="zero" <?php echo esc_attr( get_option( '_woosg_main_price', 'zero' ) === 'zero' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Zero price', 'wpc-grouped-product' ); ?>
                                                    </option>
                                                    <option value="price" <?php echo esc_attr( get_option( '_woosg_main_price', 'zero' ) === 'price' ? 'selected' : '' ); ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="_woosg_search_sku">
                                <option value="yes" <?php echo esc_attr( get_option( '_woosg_search_sku', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                </option>
                                <option value="no" <?php echo esc_attr( get_option( '_woosg_search_sku', 'no' ) === 'no' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                </option>
                            </select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="_woosg_search_id">
                                <option value="yes" <?php echo esc_attr( get_option( '_woosg_search_id', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                </option>
                                <option value="no" <?php echo esc_attr( get_option( '_woosg_search_id', 'no' ) === 'no' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                </option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="_woosg_search_exact">
                                <option value="yes" <?php echo esc_attr( get_option( '_woosg_search_exact', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                </option>
                                <option value="no" <?php echo esc_attr( get_option( '_woosg_search_exact', 'no' ) === 'no' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                </option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="_woosg_search_sentence">
                                <option value="yes" <?php echo esc_attr( get_option( '_woosg_search_sentence', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                </option>
                                <option value="no" <?php echo esc_attr( get_option( '_woosg_search_sentence', 'no' ) === 'no' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                </option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="_woosg_search_same">
                                <option value="yes" <?php echo esc_attr( get_option( '_woosg_search_same', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                </option>
                                <option value="no" <?php echo esc_attr( get_option( '_woosg_search_same', 'no' ) === 'no' ? 'selected' : '' ); ?>>
									<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                </option>
                            </select>
					...
					if ( ! empty( $cart_item_data['woosg_ids'] ) ) {
						if ( $items = self::get_items( $cart_item_data['woosg_ids'] ) ) {
							foreach ( $items as $item ) {
								...
								$item_key    = WC()->cart->add_to_cart( $item_id, $product_qty, $item_variation_id, $item_variation, $item_data );
				...
				function update_search_settings() {
					...
					update_option( '_woosg_search_types', array_map( 'sanitize_text_field', (array) $_POST['types'] ) );
                            ...
                            <tr class="woosg_tr_space">
                                ...
                                <td>
                                    <select name="woosg_including_main">
                                        <option value="default" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_including_main', true ) === 'default' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'Default', 'wpc-grouped-product' ); ?>
                                        </option>
                                        <option value="yes" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_including_main', true ) === 'yes' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'Yes', 'wpc-grouped-product' ); ?>
                                        </option>
                                        <option value="no" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_including_main', true ) === 'no' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'No', 'wpc-grouped-product' ); ?>
                                        </option>
                                    </select>
                                    <span class="woocommerce-help-tip"
                            ...
                            <tr class="woosg_tr_space">
                                ...
                                <td>
                                    <select name="woosg_selector">
                                        <option value="default" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_selector', true ) === 'default' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'Default', 'wpc-grouped-product' ); ?>
                                        </option>
                                        <option value="quantity" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_selector', true ) === 'quantity' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'Quantity', 'wpc-grouped-product' ); ?>
                                        </option>
                                        <option value="checkbox" <?php echo esc_attr( get_post_meta( $post_id, 'woosg_selector', true ) === 'checkbox' ? 'selected' : '' ); ?>>
											<?php esc_html_e( 'Checkbox', 'wpc-grouped-product' ); ?>
                                        </option>
                                    </select>
                                </td>
					...
					if ( $items = $product->get_items() ) {
                        ...
                        <div class="woosg-table woosg-products"
							...
							foreach ( $items as $item ) {
								...
								if ( ! $item_product || ( $item_product->get_status() !== 'publish' && apply_filters( 'woosg_show_publish_product_only', true ) ) ) {
									continue;
								}
								...
								if ( $item_product->is_purchasable() && $item_product->is_in_stock() ) {
									$min = apply_filters( 'woocommerce_quantity_input_min', 0, $item_product );
									$max = apply_filters( 'woocommerce_quantity_input_max', $item_product->get_max_purchase_quantity(), $item_product );
                                ...
                                <div class="<?php echo esc_attr( $item_class ); ?>"
									...
									if ( get_option( '_woosg_show_thumb', 'yes' ) !== 'no' ) {
                                        ...
                                        <div class="woosg-thumb">
											<?php
											do_action( 'woosg_before_item_thumb', $item_product, $product );
                                            ...
                                            <div class="woosg-thumb-ori">
												<?php echo wp_kses( apply_filters( 'woosg_item_thumbnail', $item_product->get_image(), $item_product ), array(
													'img' => array(
														'class' => array(),
														'src'   => array(),
														'id'    => array()
											...
											do_action( 'woosg_after_item_thumb', $item_product, $product ); ?>
                                        </div><!-- /woosg-thumb -->
										<?php
									} ?>
                                    ...
                                    <div class="woosg-title">
										<?php
										do_action( 'woosg_before_item_name', $item_product, $product );
										...
										do_action( 'woosg_after_item_name', $item_product, $product );
										...
										if ( get_option( '_woosg_show_price', 'yes' ) !== 'no' ) { ?>
                                            <div class="woosg-price">
												...
												<?php do_action( 'woosg_after_item_price', $item_product, $product ); ?>
                                            </div>
										<?php }
										...
										if ( $item_product->is_type( 'variable' ) ) {
											$use_woovr = apply_filters( 'woosg_use_woovr', get_option( '_woosg_variations_selector', 'default' ) === 'wpc_radio' || get_option( '_woosg_variations_selector', 'default' ) === 'woovr', $item_product, $product );
											...
											do_action( 'woosg_after_item_variations', $item_product, $product );
										} else {
									...
									if ( $selector === 'quantity' ) {
										if ( $item_product->is_purchasable() && $item_product->is_in_stock() ) {
											echo '<div class="' . ( get_option( '_woosg_show_plus_minus', 'no' ) === 'yes' ? 'woosg-quantity woosg-quantity-plus-minus' : 'woosg-quantity' ) . '" data-min="' . esc_attr( $min ) . '" data-max="' . esc_attr( $max ) . '">';
											...
											do_action( 'woosg_after_item_qty', $item_product, $product );

											echo '</div><!-- /woosg-quantity -->';
										} else {
											echo '<div class="' . ( get_option( '_woosg_show_plus_minus', 'no' ) === 'yes' ? 'woosg-quantity woosg-quantity-plus-minus' : 'woosg-quantity' ) . '" data-min="' . esc_attr( $item_qty ) . '" data-max="' . esc_attr( $item_qty ) . '">';
