	...
	class WPCleverWoosg {
		...
		function __construct() {
			...
			add_action( 'before_woocommerce_init', function () {
				if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
					FeaturesUtil::declare_compatibility( 'custom_order_tables', WOOSG_FILE );
				}
			} );
		}
		...
		function admin_menu_content() {
			...
			<div class="wpclever_settings_page wrap">
				<h1 class="wpclever_settings_page_title">WPC Grouped Product <?php echo esc_attr( WOOSG_VERSION ); ?></h1>
				...
				<div class="wpclever_settings_page_nav">
					<h2 class="nav-tab-wrapper">
						...
						<a href="<?php echo admin_url( 'admin.php?page=wpclever-woosg&tab=localization' ); ?>" class="<?php echo esc_attr( $active_tab === 'localization' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
							...
							<table class="form-table">
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="woosg_settings[change_price_custom]" value="<?php echo self::get_setting( 'change_price_custom', '.summary > .price' ); ?>" placeholder=".summary > .price" class="woosg_change_price_custom"/>
						...
						<form method="post" action="options.php">
							<table class="form-table">
								...
								<tr>
									...
									<td>
										<input type="text" name="woosg_localization[from]" class="regular-text" value="<?php echo esc_attr( self::localization( 'from' ) ); ?>" placeholder="<?php esc_attr_e( 'From', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr>
									<th><?php esc_html_e( 'Total', 'wpc-grouped-product' ); ?></th>
									<td>
										<input type="text" name="woosg_localization[total]" class="regular-text" value="<?php echo esc_attr( self::localization( 'total' ) ); ?>" placeholder="<?php esc_attr_e( 'Total:', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr>
									<th><?php esc_html_e( 'Default above text', 'wpc-grouped-product' ); ?></th>
									<td>
										<?php wp_editor( self::localization( 'above_text' ), 'woosg_localization_above_text', [
								...
								<tr>
									...
									<td>
										<?php wp_editor( self::localization( 'under_text' ), 'woosg_localization_under_text', [
								...
								<tr>
									...
									<td>
										<input type="text" name="woosg_localization[tab]" class="regular-text" value="<?php echo esc_attr( self::localization( 'tab' ) ); ?>" placeholder="<?php esc_attr_e( 'Grouped products', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr>
									<th><?php esc_html_e( 'Choose an attribute', 'wpc-grouped-product' ); ?></th>
									<td>
										<input type="text" class="regular-text" name="woosg_localization[choose]" value="<?php echo esc_attr( self::localization( 'choose' ) ); ?>" placeholder="<?php esc_attr_e( 'Choose %s', 'wpc-grouped-product' ); ?>"/>
								...
								<tr>
									...
									<td>
										<input type="text" class="regular-text" name="woosg_localization[clear]" value="<?php echo esc_attr( self::localization( 'clear' ) ); ?>" placeholder="<?php esc_attr_e( 'Clear', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr class="heading">
									<th colspan="2">
								...
								<tr>
									...
									<td>
										<div style="margin-bottom: 5px">
											<input type="text" class="regular-text" name="woosg_localization[button_select]" value="<?php echo esc_attr( self::localization( 'button_select' ) ); ?>" placeholder="<?php esc_attr_e( 'Select options', 'wpc-grouped-product' ); ?>"/>
											<span class="description"><?php esc_html_e( 'For purchasable grouped.', 'wpc-grouped-product' ); ?></span>
										</div>
										<div>
											<input type="text" class="regular-text" name="woosg_localization[button_read]" value="<?php echo esc_attr( self::localization( 'button_read' ) ); ?>" placeholder="<?php esc_attr_e( 'Read more', 'wpc-grouped-product' ); ?>"/>
								...
								<tr>
									...
									<td>
										<input type="text" class="regular-text" name="woosg_localization[button_single]" value="<?php echo esc_attr( self::localization( 'button_single' ) ); ?>" placeholder="<?php esc_attr_e( 'Add to cart', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr class="heading">
									<th colspan="2">
								...
								<tr>
									...
									<td>
										<input type="text" class="large-text" name="woosg_localization[alert_selection]" value="<?php echo esc_attr( self::localization( 'alert_selection' ) ); ?>" placeholder="<?php esc_attr_e( 'Please select a purchasable variation for [name] before adding this grouped product to the cart.', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr>
									<th><?php esc_html_e( 'Enforce a selection', 'wpc-grouped-product' ); ?></th>
									<td>
										<input type="text" class="large-text" name="woosg_localization[alert_empty]" value="<?php echo esc_attr( self::localization( 'alert_empty' ) ); ?>" placeholder="<?php esc_attr_e( 'Please choose at least one of the listed products before adding this grouped product to the cart.', 'wpc-grouped-product' ); ?>"/>
									</td>
								</tr>
								<tr class="submit">
									<th colspan="2">
		...
		function search_settings() {
			...
			<tr>
				...
				<td>
					<input name="woosg_settings[search_limit]" type="number" min="1" max="500" class="woosg_search_limit" value="<?php echo esc_attr( self::get_setting( 'search_limit', '5' ) ); ?>"/>
				</td>
			</tr>
			<tr>
		...
		function enqueue_scripts() {
			...
			wp_localize_script( 'woosg-frontend', 'woosg_vars', [
					'change_image'             => self::get_setting( 'change_image', 'yes' ),
					'change_price'             => self::get_setting( 'change_price', 'yes' ),
		...
		function ajax_get_search_results() {
			...
			$added_ids = explode( ',', isset( $_POST['ids'] ) ? self::clean_ids( $_POST['ids'] ) : '' );
			...
			<div id='woosg_settings' class='panel woocommerce_options_panel woosg_table'>
				...
				<table>
					...
					<tr class="woosg_tr_space">
						...
						<td>
							<input type="text" name="woosg_custom_price" value="<?php echo stripslashes( get_post_meta( $post_id, 'woosg_custom_price', true ) ); ?>"/> E.g:
					...
					<tr class="woosg_tr_space">
						<th><?php esc_html_e( 'Layout', 'wpc-grouped-product' ); ?></th>
						<td>
							<?php $layout = get_post_meta( $post_id, 'woosg_layout', true ) ?: 'unset'; ?>
					...
					<tr class="woosg_tr_space">
						...
						<td>
							<?php wp_editor( get_post_meta( $post_id, 'woosg_before_text', true ), 'woosg_before_text', [
								'textarea_name' => 'woosg_before_text',
								'textarea_rows' => 10
							] ); ?>
						</td>
					</tr>
					<tr class="woosg_tr_space">
						...
						<td>
							<?php wp_editor( get_post_meta( $post_id, 'woosg_after_text', true ), 'woosg_after_text', [
								'textarea_name' => 'woosg_after_text',
								'textarea_rows' => 10
							] ); ?>
						</td>
					</tr>
		...
		function product_data_li( $product, $qty = 0, $search = false ) {
			...
			echo '<li class="' . esc_attr( $product_class ) . '" data-id="' . esc_attr( $product_id ) . '" data-price="' . esc_attr( $product->get_price() ) . '">' . $hidden_input . '<span class="move"></span><span class="qty hint--right" aria-label="' . esc_html__( 'Default quantity', 'wpc-grouped-product' ) . '">' . $qty_input . '</span><span class="img">' . $product->get_image( [
					30,
					30
				] ) . '</span><span class="data"><span class="name">' . strip_tags( $product->get_name() ) . '</span> <span class="info">' . $product->get_price_html() . '</span> ' . ( $product->is_sold_individually() ? '<span class="info">sold individually</span> ' : '' ) . '</span> <span class="type"><a href="' . esc_url( $edit_link ) . '" target="_blank">' . esc_attr( $product->get_type() ) . '<br/>#' . esc_attr( $product_id ) . '</a></span> ' . $remove_btn . '</li>';
		}
		...
		function process_product_meta_woosg( $post_id ) {
			if ( isset( $_POST['woosg_ids'] ) ) {
				update_post_meta( $post_id, 'woosg_ids', self::sanitize_array( $_POST['woosg_ids'] ) );
			}
			...
			if ( isset( $_POST['woosg_layout'] ) && ( $_POST['woosg_layout'] !== '' ) ) {
		...
		function show_items( $product = null ) {
			...
			$products_class   = apply_filters( 'woosg_products_class', 'woosg-table woosg-products woosg-products-layout-' . $layout, $product );
				...
				<div class="<?php echo esc_attr( $products_class ); ?>" data-variables="<?php echo esc_attr( $product->has_variables() ? 'yes' : 'no' ); ?>" data-price="<?php echo esc_attr( $main_price ); ?>" data-regular-price="<?php echo esc_attr( $main_regular_price ); ?>">
					...
					foreach ( $items as $item ) {
						if ( ! empty( $item['id'] ) ) {
							...
							if ( ! $product || $order > 3 || ( $product->get_status() !== 'publish' && apply_filters( 'woosg_show_publish_product_only', true ) ) ) {
								continue;
							}
							...
							$item_class         = 'woosg-item-product woosg-product';
							$item_qty           = $item['qty'];
							...
							<div class="<?php echo esc_attr( apply_filters( 'woosg_item_class', $item_class, $product, $global_product ) ); ?>" data-name="<?php echo esc_attr( $product_name ); ?>" data-id="<?php echo esc_attr( $item_id ); ?>" data-price="<?php echo esc_attr( $item_price ); ?>" data-regular-price="<?php echo esc_attr( $item_regular_price ); ?>" data-qty="<?php echo esc_attr( $item_qty ); ?>" data-order="<?php echo esc_attr( $order ); ?>">
								...
								<div class="woosg-title">
									...
									if ( $product->is_type( 'variable' ) ) {
										$use_woovr = apply_filters( 'woosg_use_woovr', self::get_setting( 'variations_selector', 'default' ) === 'woovr', $product, $global_product );

										if ( $use_woovr && class_exists( 'WPClever_Woovr' ) ) {
											WPClever_Woovr::woovr_variations_form( $product, false, 'woosg' );
										} else {
											...
											if ( is_array( $attributes ) && ( count( $attributes ) > 0 ) ) {
												echo '<form class="variations_form" data-product_id="' . esc_attr( $product->get_id() ) . '" data-product_variations="' . esc_attr( $variations_attr ) . '">';
										...
										do_action( 'woosg_after_item_variations', $product, $global_product, $order );
									} else {
